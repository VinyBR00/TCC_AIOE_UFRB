...
*\*Nota: "OV" refere-se ao Valor da Função Objetivo (Objective Value). Pequenas variações unitárias nas instâncias de grande magnitude decorrem estritamente de critérios de tolerância numérica e arredondamentos de ponto flutuante entre o compilador C++14 e os métodos de barreira do solver comercial.*
